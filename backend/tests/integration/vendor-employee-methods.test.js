 ...
 *
 * Endpoint: /api/v1/vendor-employees/:id (PATCH, PUT)
...
beforeAll(async () => {
  ...
  await app.register(shopStaffRoutes, { prefix: '/api/v1/vendor-employees' })
...
describe('Shop Staff method validation (Task 23.3)', () => {
  describe('PATCH /api/v1/vendor-employees/:id with empty body', () => {
  ...
  describe('PUT /api/v1/vendor-employees/:id', () => {
