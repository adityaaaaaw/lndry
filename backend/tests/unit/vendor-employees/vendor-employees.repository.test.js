// Soft-delete predicate coverage for VendorEmployeesRepository (Req 15.2, 15.3).
//
...
// VendorEmployeesRepository specifically. Mocked `query()` lets us inspect the exact
...
import { VendorEmployeesRepository as VendorEmployeesRepository } from '../../../src/modules/vendor-employees/vendor-employees.repository.js'
...
describe('VendorEmployeesRepository.findById — soft-delete predicate (Req 15.3)', () => {
  it('shop-scoped read appends `AND deleted_at IS NULL` by default', async () => {
    const repo = new VendorEmployeesRepository()
...
describe('VendorEmployeesRepository.findMany — soft-delete predicate (Req 15.3)', () => {
...
describe('VendorEmployeesRepository.softDelete — converts hard delete to soft delete (Req 15.2)', () => {
...
describe('VendorEmployeesRepository.update — never resurrects soft-deleted rows (Req 15.2)', () => {
...
describe('VendorEmployeesRepository — non-list reads also exclude soft-deleted', () => {
