                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ListView(
                              padding: EdgeInsets.zero,
                              children: [
                                 _buildShortcutTile(context, 'Dashboard', AppRoutes.dashboard, Icons.dashboard),
                                 _buildShortcutTile(context, 'Orders List', AppRoutes.orders, Icons.receipt_long),
                                 _buildShortcutTile(context, 'Services Catalog', AppRoutes.services, Icons.category),
                                 _buildShortcutTile(context, 'Analytics Panel', AppRoutes.analytics, Icons.bar_chart),
                                 _buildShortcutTile(context, 'Profile Info', AppRoutes.profile, Icons.person),
                                 _buildShortcutTile(context, 'Pricing/Rates', AppRoutes.pricing, Icons.currency_rupee),
                                 _buildShortcutTile(context, 'Inventory Management', AppRoutes.inventory, Icons.inventory),
                                 _buildShortcutTile(context, 'Employee Staff', AppRoutes.employees, Icons.people),
                                 _buildShortcutTile(context, 'Capacity Slots', AppRoutes.slots, Icons.access_time),
                                 _buildShortcutTile(context, 'Notifications Log', AppRoutes.notifications, Icons.notifications),
                                 _buildShortcutTile(context, 'Settings Panel', AppRoutes.settings, Icons.settings),
                              ],
                            ),
                          ),
                        ],
